...
class TestPerceptron:
    ...
    def test2_8(self):
        ...
        fig = p.Perceptron([0.6,0.3,0.2], -0.4)
...
class TestPerceptronLayer:
    ...
    def testLayer(self):
        layer = p.PerceptronLayer([p.Perceptron([-1,0,0],0), p.Perceptron([0,0.5,0.5], -1)])
...
class TestPerceptronNetwork:
    ...
    def testXOR(self):
        layer1 = p.PerceptronLayer([p.Perceptron([1,0],-0.1),p.Perceptron([0,-1],0),p.Perceptron([-1,0],0),p.Perceptron([0,1],-0.1)])
        layer2 = p.PerceptronLayer([p.Perceptron([0.5,0.5,0,0],-1),p.Perceptron([0,0,0.5,0.5],-1)])
        layer3 = p.PerceptronLayer([p.Perceptron([1,1],-0.5)])
        network = p.PerceptronNetwork([layer1,layer2,layer3])
    ...
    def testAdder(self):
        layer1 = p.PerceptronLayer([p.Perceptron([1,0], -0.1),p.Perceptron([-1,-1], 0.5),p.Perceptron([0,1], -0.1)])
        layer2 = p.PerceptronLayer([p.Perceptron([-1,-1,0], 0.5),p.Perceptron([0,-1,-1], 0.5),p.Perceptron([-1,0,-1], 0.5)])
        layer3 = p.PerceptronLayer([p.Perceptron([-1,-1,0], 0.5),p.Perceptron([0,0,1], -0.1)])
        network = p.PerceptronNetwork([layer1,layer2,layer3])
        print(f'testing with the following PerceptronNetwork: \n {network} ')
